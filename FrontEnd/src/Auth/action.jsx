...
const reqApartmentData = (payload) => ({ type: types.REQ_APARTMENT_DATA, payload })
const getApartmentData = (payload) => ({ type: types.GET_APARTMENT_DATA, payload })
const reqApartmentDataFail = (payload) => ({ type: types.REQ_APARTMENT_DATA_FAIL, payload })

const gotResidentData = (resident) => ({ type: types.GET_RESIDENT, payload: resident })

const getData = () => async (dispatch) => {

    dispatch(reqApartmentData())

    axios.get("https://shubhamapiflat.herokuapp.com/flat").then((res) => {
...
const getResidentData = (id) => async (dispatch) => {
    ...
    axios.get(`https://shubhamapiflat.herokuapp.com/flat/${id}`).then((res) => {
...
const login = (email, password) => async (dispatch) => {
    ...
    try {
        ...
        const res = await axios.post("https://shubhamapiflat.herokuapp.com/login", {
